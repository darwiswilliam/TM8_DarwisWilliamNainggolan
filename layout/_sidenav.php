<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="index.php">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ78a1BQSsaYbDEaCv7lCv-hrodt0sN40IYWw&usqp=CAU" alt="logo" width="70">
      </a>
    </div>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="../login_member/index.php">List</a></li>
        </ul>
      </li>
    </ul>
  </aside>
